...
const Hero = () => {
  return (
    <>
      <section className="max-w-[343px] mt-[72px] mx-auto md:max-w-[524px] md:mt-[77px] md:py-[12px] lg:flex lg:mt-[156px] lg:max-w-[960px] lg:py-[8px] xl:max-w-[1128px] 2xl:max-w-[1472px]">
